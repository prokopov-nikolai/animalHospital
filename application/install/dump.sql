...
--
-- Структура таблицы `ah_cron_task`
--

CREATE TABLE IF NOT EXISTS `ah_cron_task` (
`id` int(11) NOT NULL,
...
--
-- Структура таблицы `ah_notify_task`
--

CREATE TABLE IF NOT EXISTS `ah_notify_task` (
...
--
-- Структура таблицы `ah_plugin_migration`
--

CREATE TABLE IF NOT EXISTS `ah_plugin_migration` (
`id` int(11) NOT NULL,
...
--
-- Структура таблицы `ah_plugin_version`
--

CREATE TABLE IF NOT EXISTS `ah_plugin_version` (
`id` int(11) NOT NULL,
  `code` varchar(50) NOT NULL,
  `version` varchar(50) NOT NULL,
...
--
-- Структура таблицы `ah_reminder`
--

CREATE TABLE IF NOT EXISTS `ah_reminder` (
...
--
-- Структура таблицы `ah_storage`
--

CREATE TABLE IF NOT EXISTS `ah_storage` (
`id` int(11) NOT NULL,
...
--
-- Indexes for table `ah_cron_task`
--
ALTER TABLE `ah_cron_task`
...
--
-- Indexes for table `ah_notify_task`
--
ALTER TABLE `ah_notify_task`
 ADD PRIMARY KEY (`notify_task_id`), ADD KEY `date_created` (`date_created`);

--
-- Indexes for table `ah_plugin_migration`
--
ALTER TABLE ah_plugin_migration
 ADD PRIMARY KEY (`id`), ADD KEY `file` (`file`(255)), ADD KEY `code` (`code`), ADD KEY `version` (`version`);

--
-- Indexes for table `ah_plugin_version`
--
ALTER TABLE ah_plugin_version
 ADD PRIMARY KEY (`id`), ADD KEY `code` (`code`), ADD KEY `version` (`version`);

--
-- Indexes for table `ah_reminder`
--
ALTER TABLE `ah_reminder`
...
--
-- Indexes for table `ah_storage`
--
ALTER TABLE `ah_storage`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `key_instance` (`key`,`instance`), ADD KEY `instance` (`instance`);

--
-- Indexes for table `ah_user`
--
ALTER TABLE `ah_user`
 ADD PRIMARY KEY (`id`), ADD KEY `email` (email), ADD KEY `password` (`password`), ADD KEY `activate_key` (`activate_key`), ADD KEY `active` (`active`), ADD KEY `activate` (`activate`);
...
--
-- AUTO_INCREMENT for table `ah_cron_task`
--
ALTER TABLE `ah_cron_task`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ah_notify_task`
--
ALTER TABLE `ah_notify_task`
MODIFY `notify_task_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1;
--
-- AUTO_INCREMENT for table `ah_plugin_migration`
--
ALTER TABLE ah_plugin_migration
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ah_plugin_version`
--
ALTER TABLE ah_plugin_version
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ah_storage`
--
ALTER TABLE `ah_storage`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ah_user`
--
ALTER TABLE `ah_user`
